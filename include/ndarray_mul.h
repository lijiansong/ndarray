...
class NDArrayMul : public NDArrayExpr<NDArrayMul<E1, E2, T1, T2>, T1> {
public:
    using traits = T1;
...
public:
    NDArrayMul(NDArrayExpr<E1, T1> const& x, NDArrayExpr<E2, T2> const& y); 
...
template <typename E1, typename E2, typename T1, typename T2>
NDArrayMul<E1, E2, T1, T2>::NDArrayMul(const NDArrayExpr<E1, T1>& x, 
