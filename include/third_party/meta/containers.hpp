...
/*
 * ----------------------------------------------------------------------------------------------------------
 * containers header file for nano library.
...
#include <third_party/meta/list.hpp>
...
namespace detail {
    ...
    struct build_range<Current, Step, Iteration, true, list<nano::int_t<Values>...>>
    {
        ...
        using index_list = typename std::conditional<
                                        keep_building                                       , 
                                        list<nano::int_t<Values>..., nano::int_t<Current>>    ,   // Add Current
                                        list<nano::int_t<Values>...>                             // Don't add
                                                    >::type;
    ...
    {
        using result = list<nano::int_t<Values>...>;
    };
...
// ----------------------------------------------------------------------------------------------------------
/// @struct     range   
/// @brief      Constructs a range of nano::int_t t types, which is essentially just a list of nano::int_t
///             types
